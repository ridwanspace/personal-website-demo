...
export default function Hero() {
    return (
        <section className="bg-gradient-to-r from-gray-900 via-blue-900 to-blue-500 text-white py-36">
            <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center">
                <div className="lg:w-1/2 mb-10 lg:mb-0">
                    <div className="bg-blue-500 text-base font-bold py-1 px-3 rounded-full inline-block mb-4">
